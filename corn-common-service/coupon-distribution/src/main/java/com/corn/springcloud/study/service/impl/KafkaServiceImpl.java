...
import com.corn.springcloud.study.service.IKafkaService;
import com.corn.springcloud.study.vo.CouponKafkaMessage;
...
public class KafkaServiceImpl implements IKafkaService {
    ...
    /**
     * <h2>消费优惠券 Kafka 消息(队列监听、消费)</h2>
     * @param record {@link ConsumerRecord}
     */
    @Override
    @KafkaListener(topics = {Constant.TOPIC}, groupId = "corn-coupon-1")
